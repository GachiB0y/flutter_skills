...
description: Внедрение зависимостей через Dependencies class с late final, InheritedWidget, Scopes pattern, guard pattern, static shortcut methods. Использование BLoC для управления состоянием
type: flutter-skill
...
### BLoC'и -- создавать в скоупах (НЕ в Dependencies)
...
Вместо получения BLoC, его стейта и вызова метода -- простой вызов через скоуп:
