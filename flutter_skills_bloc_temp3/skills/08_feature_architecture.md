...
description: Anti-Clean Architecture, 3 слоя (widgets/bloc/data), модели, JSON parsing, Converter/Codec pattern, always-async repos, anti-Result type
type: flutter-skill
...
> "Давайте прямо так: widgets, data, bloc. Любой человек, который на это взглянет, поймёт, что примерно тут ожидается."
